...
const TRANSLATIONS = {
    en: {
        ...
        nav: {
            dashboard: 'Dashboard', 'filter-connect': 'FILTER CONNECT', reports: 'Reporting', pos: 'POS / New Order', approvals: 'Approvals', 'zone-management': 'Zone Management', 'tax-codes': 'Tax Code', 'legal-pages': 'Legal Pages', 'mobile-app-menu': 'Mobile App Menu', permissions: 'Permissions', 'admin-wallets': 'Admin Wallets', 'my-wallet': 'My Wallet', 'tier-management': 'Tier Management',
    ...
    ar: {
        ...
        nav: {
            dashboard: 'لوحة التحكم', 'filter-connect': 'فلتر كونكت', reports: 'التقارير', pos: 'نقطة البيع / طلب جديد', approvals: 'الموافقات', 'zone-management': 'إدارة المناطق', 'tax-codes': 'أكواد الضريبة', 'legal-pages': 'الصفحات القانونية', 'mobile-app-menu': 'قائمة تطبيق الجوال', permissions: 'الصلاحيات', 'admin-wallets': 'محافظ المشرفين', 'my-wallet': 'محفظتي', 'tier-management': 'إدارة الفئات',
...
const NAV_CONFIG = [
    {
        ...
        items: [
            ...
            { label: 'FILTER CONNECT', path: 'filter-connect', icon: Sparkles, externalPath: '/connect' },
