...
import { getWorkshopVatReport } from '../../../services/workshopAccountingApi';
import {
...
export default function WorkshopVatReport() {
    ...
    const load = useCallback(async () => {
        ...
        setErr('');
        try {
            const res = await getWorkshopVatReport({
        ...
        <div>
            <div style={{ marginBottom: 16 }}>
                ...
                <p style={{ margin: '6px 0 0', color: '#64748B', fontSize: '0.875rem' }}>
                    Sales output VAT, purchase input VAT, and net payable to ZATCA — updated with each transaction
                </p>
            </div>
