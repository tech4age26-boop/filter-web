...
export const STAFF_APP_NAV_ITEMS = [
    ...
    { id: 'sap-users', label: 'App Users & Roles', permission: 'workshop.staff-app.users.view' },
    { id: 'sap-approvals', label: 'Approvals', permission: 'workshop.staff-app.approvals.view' },
    { id: 'sap-wallets', label: 'Wallets', permission: 'workshop.staff-app.wallets.view' },
    ...
    { id: 'sap-approval-limits', label: 'Approval Limits', permission: 'workshop.staff-app.approval-limits.view' },
...
export const STAFF_APP_PERMISSION_FALLBACK = {
    ...
    'sap-users': ['workshop.staff-app.users.view', 'workshop.employees.view'],
    'sap-approvals': ['workshop.staff-app.approvals.view', 'workshop.approvals.view'],
    'sap-wallets': ['workshop.staff-app.wallets.view', 'workshop.my-petty-cash.view'],
    ...
    'sap-approval-limits': ['workshop.staff-app.approval-limits.view', 'workshop.accounting.approval-limits.view'],
